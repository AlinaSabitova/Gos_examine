...
Требования к задержке (< 1 с):
Kafka (10-20 мс) + Flink (100-200 мс на окно/правило) + Redis (1-2 мс) + Логика (10 мс).
Запас по времени ~600-700 мс на выполнение правила и ответ эквайрингу.
```
