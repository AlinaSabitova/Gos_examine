...
| **Скорость поступления** | **до 1 000 транзакций/с** | Необходима высокопроизводительная шина с низкой латентностью (Kafka) и поточная обработка сложных событий (Flink / Spark Streaming) |
